...
const NewCreatureForm = props => {
    ...
    const handleChange = event => {
        setFormState({
            ...formState, [event.currentTarget.id]: event.currentTarget.value
        })
    }
    ...
    <form className="new-creature-form" onSubmit={handleSubmit}>
        ...
        <select
            ...
            <option type="text" value="Nyan Cat">Nyan Cat</option>
            <option type="text" value="Dragon">Dragon</option>
            <option type="text" value="Unicorn">Unicorn</option>
        </select>
        <label>
            Pet Image URL*:
            </label>
        ...
        <select
            ...
            onChange={handleChange}>
            <option type="text" value="">-</option>
            <option type="text" value="true">Yes!</option>
            <option type="text" value="false">Unfortunately, no.</option>
        </select>
